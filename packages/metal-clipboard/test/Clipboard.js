...
describe('Clipboard', function() {
	...
	describe('Text', function() {
		it('should copy text from data-text to clipboard', function() {
			dom.append(
				container,
				'<div data-clipboard data-text="From data-text"></div>'
			);
	...
	describe('Selector', function() {
		it('should copy text from elements matching selector to clipboard', function() {
			dom.append(
				container,
				'<div data-clipboard data-text="data-clipboard attribute"></div>'
			);
			dom.append(
				container,
				'<div class="copy" data-text="copy class"></div>'
			);
			dom.append(
				container,
				'<div class="copy" data-text="copy class 2"></div>'
			);
	...
	describe('Action', function() {
		it('should copy text to clipboard using the action specified by data-action', function() {
			dom.append(
				container,
				'<div data-clipboard data-text="From data-text" data-action="cut"></div>'
			);
	...
	describe('Target', function() {
		it('should copy text from text input element to clipboard', function() {
			dom.append(
				container,
				'<div data-clipboard data-target="#target"></div>'
			);
			dom.append(
				container,
				'<input id="target" type="text" value="From text input">'
			);
			clipboard = new Clipboard();
		...
		it('should copy text from textarea element to clipboard', function() {
			...
			dom.append(
				container,
				'<textarea id="target" type="text">From textarea</textarea>'
			);
			clipboard = new Clipboard();
	...
	describe('Events', function() {
		...
		it('should blur target through the function given by the "success" event', function() {
			...
			dom.append(
				container,
				'<textarea id="target">From textarea</textarea>'
			);
			clipboard = new Clipboard();
